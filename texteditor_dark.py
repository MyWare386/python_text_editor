...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Creating Titlebar
    self.titlebar = Label(self.root,textvariable=self.title,font=("Consolas",12),bd=2,relief=FLAT,bg="#161B22",foreground="white")
    ...
    # Creating Statusbar
    self.statusbar = Label(self.root,textvariable=self.status,font=("Consolas",12,"italic"),bd=2,relief=FLAT,bg="#161B22",foreground="green")
  ...
  def darkmode(self):
    messagebox.showinfo("Python Text Editor Dark Mode","You're already in dark mode")

  # Defining About Funtion
  def whitemode(self):
    webbrowser.open('https://github.com/MyWare386/python_text_editor#white-mode')
